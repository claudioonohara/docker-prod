...
public final  class StructSdtSDTCRServidorTemporario implements Cloneable, java.io.Serializable
{
   public StructSdtSDTCRServidorTemporario( )
   {
      this( -1, new ModelContext( StructSdtSDTCRServidorTemporario.class ));
   }

   public StructSdtSDTCRServidorTemporario( int remoteHandle ,
                                            ModelContext context )
   {
      java.util.Calendar cal = java.util.Calendar.getInstance();
      cal.set(1, 0, 1, 0, 0, 0);
      cal.set(java.util.Calendar.MILLISECOND, 0);
      gxTv_SdtSDTCRServidorTemporario_St_data_admissao = cal.getTime() ;
      gxTv_SdtSDTCRServidorTemporario_St_data_demissao = cal.getTime() ;
      gxTv_SdtSDTCRServidorTemporario_Pes_nome = "" ;
      gxTv_SdtSDTCRServidorTemporario_Pes_data_nascimento = cal.getTime() ;
   ...
   public java.util.Vector<com.projetopratico.StructSdtSDTCRServidorTemporario_enderecoItem> getEndereco( )
   {
      return gxTv_SdtSDTCRServidorTemporario_Endereco ;
   }

   public void setEndereco( java.util.Vector<com.projetopratico.StructSdtSDTCRServidorTemporario_enderecoItem> value )
   {
   ...
   protected java.util.Vector<com.projetopratico.StructSdtSDTCRServidorTemporario_enderecoItem> gxTv_SdtSDTCRServidorTemporario_Endereco=null ;
}
