...
public final  class gx0040_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projetopratico.gx0040", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pcid_id,8,0))}, new String[] {"pcid_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCID_ID", GXutil.ltrim( localUtil.ntoc( AV6ccid_id, (byte)(8), (byte)(0), ".", "")));
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCID_UF", GXutil.rtrim( AV7ccid_uf));
      /* Send saved values. */
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "vPCID_ID", GXutil.ltrim( localUtil.ntoc( AV8pcid_id, (byte)(8), (byte)(0), ".", "")));
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "CID_UFFILTERCONTAINER_Class", GXutil.rtrim( divCid_uffiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.projetopratico.gx0040", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pcid_id,8,0))}, new String[] {"pcid_id"})  ;
   }
   ...
   public void wb0Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblcid_idfilter_Internalname, "cid_id", "", "", lblLblcid_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110q1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0040.htm");
         ...
         com.projetopratico.GxWebStd.gx_single_line_edit( httpContext, edtavCcid_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV6ccid_id, (byte)(8), (byte)(0), ".", "")), GXutil.ltrim( ((edtavCcid_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV6ccid_id), "ZZZZZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV6ccid_id), "ZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcid_id_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcid_id_Visible, edtavCcid_id_Enabled, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx0040.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, divCid_uffiltercontainer_Internalname, 1, 0, "px", 0, "px", divCid_uffiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblcid_uffilter_Internalname, "cid_uf", "", "", lblLblcid_uffilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120q1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0040.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.projetopratico.GxWebStd.gx_label_element( httpContext, edtavCcid_uf_Internalname, "cid_uf", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.projetopratico.GxWebStd.gx_single_line_edit( httpContext, edtavCcid_uf_Internalname, GXutil.rtrim( AV7ccid_uf), GXutil.rtrim( localUtil.format( AV7ccid_uf, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcid_uf_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcid_uf_Visible, edtavCcid_uf_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "start", true, "", "HLP_Gx0040.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130q1_client"+"'", TempTags, "", 2, "HLP_Gx0040.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0040.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A16cid_uf = httpContext.cgiGet( edtcid_uf_Internalname) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "gxhash_CID_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A14cid_id), "ZZZZZZZ9")));
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "CID_ID", GXutil.ltrim( localUtil.ntoc( A14cid_id, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   public void rf0Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A16cid_uf = H000Q2_A16cid_uf[0] ;
            A14cid_id = H000Q2_A14cid_id[0] ;
            /* Execute user event: Load */
            e150Q2 ();
   ...
   {
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "gxhash_CID_ID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A14cid_id), "ZZZZZZZ9")));
   }
   ...
   public void e140Q2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "cidade", "", "", "", "", "", "", "", "") );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254918302", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0040.js", "?20254918302", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A14cid_id, (byte)(8), (byte)(0), ".", "")))+"'"+"]);" ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtcid_uf_Internalname,GXutil.rtrim( A16cid_uf),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtcid_uf_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn OptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol34( )
   {
      ...
      else
      {
         ...
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.rtrim( A16cid_uf)));
         Grid1Container.AddColumnProperties(Grid1Column);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLCID_IDFILTER.CLICK","{handler:'e110Q1',iparms:[{av:'divCid_idfiltercontainer_Class',ctrl:'CID_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLCID_UFFILTER.CLICK","{handler:'e120Q1',iparms:[{av:'divCid_uffiltercontainer_Class',ctrl:'CID_UFFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160Q2',iparms:[{av:'A14cid_id',fld:'CID_ID',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      A16cid_uf = "" ;
      lV7ccid_uf = "" ;
      H000Q2_A16cid_uf = new String[] {""} ;
      H000Q2_A14cid_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projetopratico.gx0040__default(),
         new Object[] {
             new Object[] {
            H000Q2_A16cid_uf, H000Q2_A14cid_id
            }
            , new Object[] {
   ...
   private String[] H000Q2_A16cid_uf ;
   private int[] H000Q2_A14cid_id ;
...
final  class gx0040__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000Q2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
            case 1 :
                  return conditional_H000Q3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
      }
