...
public final  class gx0060_impl extends GXDataArea
{
   ...
   public void gxgrgrid1_refresh_invoke( )
   {
      ...
      gxgrgrid1_refresh( subGrid1_Rows, AV6cpes_id, AV7cend_id) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projetopratico.gx0060", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ppes_id,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9pend_id,8,0))}, new String[] {"ppes_id","pend_id"}) +"\">") ;
   ...
   {
      return formatLink("com.projetopratico.gx0060", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ppes_id,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9pend_id,8,0))}, new String[] {"ppes_id","pend_id"})  ;
   }
   ...
   {
      return "Selection List pessoa_endereco" ;
   }
   ...
   public void wb0S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblpes_idfilter_Internalname, "pes_id", "", "", lblLblpes_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0060.htm");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblend_idfilter_Internalname, "end_id", "", "", lblLblend_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0060.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130s1_client"+"'", TempTags, "", 2, "HLP_Gx0060.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0060.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
   ...
   public void start0S2( )
   {
      ...
      Form.getMeta().addItem("description", "Selection List pessoa_endereco", (short)(0)) ;
      httpContext.wjLoc = "" ;
   ...
   public void rf0S2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000S2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV6cpes_id), Integer.valueOf(AV7cend_id), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A17end_id = H000S2_A17end_id[0] ;
            A1pes_id = H000S2_A1pes_id[0] ;
            /* Execute user event: Load */
            e150S2 ();
   ...
   {
      /* Using cursor H000S3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV6cpes_id), Integer.valueOf(AV7cend_id)});
   ...
   public void e140S2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "pessoa_endereco", "", "", "", "", "", "", "", "") );
   ...
   public void e160S2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV9pend_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9pend_id), 8, 0));
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV8ppes_id),Integer.valueOf(AV9pend_id)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8ppes_id","AV9pend_id"});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202549183065", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0060.js", "?202549183065", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A1pes_id, (byte)(8), (byte)(0), ".", "")))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A17end_id, (byte)(8), (byte)(0), ".", "")))+"'"+"]);" ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         edtend_id_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A1pes_id, (byte)(8), (byte)(0), ".", "")))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A17end_id, (byte)(8), (byte)(0), ".", "")))+"'"+"]);" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List pessoa_endereco" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV7cend_id',fld:'vCEND_ID',pic:'ZZZZZZZ9'}]");
      ...
      setEventMetadata("LBLPES_IDFILTER.CLICK","{handler:'e110S1',iparms:[{av:'divPes_idfiltercontainer_Class',ctrl:'PES_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLEND_IDFILTER.CLICK","{handler:'e120S1',iparms:[{av:'divEnd_idfiltercontainer_Class',ctrl:'END_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160S2',iparms:[{av:'A1pes_id',fld:'PES_ID',pic:'ZZZZZZZ9',hsh:true},{av:'A17end_id',fld:'END_ID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8ppes_id',fld:'vPPES_ID',pic:'ZZZZZZZ9'},{av:'AV9pend_id',fld:'vPEND_ID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV7cend_id',fld:'vCEND_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV7cend_id',fld:'vCEND_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV7cend_id',fld:'vCEND_ID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cpes_id',fld:'vCPES_ID',pic:'ZZZZZZZ9'},{av:'AV7cend_id',fld:'vCEND_ID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      H000S2_A17end_id = new int[1] ;
      H000S2_A1pes_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projetopratico.gx0060__default(),
         new Object[] {
             new Object[] {
            H000S2_A17end_id, H000S2_A1pes_id
            }
            , new Object[] {
   ...
   private int[] H000S2_A17end_id ;
   private int[] H000S2_A1pes_id ;
...
final  class gx0060__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000S2", "SELECT end_id, pes_id FROM pessoa_endereco WHERE pes_id >= ? and end_id >= ? ORDER BY pes_id, end_id  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000S3", "SELECT COUNT(*) FROM pessoa_endereco WHERE pes_id >= ? and end_id >= ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
