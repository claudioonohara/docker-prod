...
public final  class gx0020_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projetopratico.gx0020", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8punid_id,8,0))}, new String[] {"punid_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "GXH_vCUNID_SIGLA", AV7cunid_sigla);
      /* Send saved values. */
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "UNID_SIGLAFILTERCONTAINER_Class", GXutil.rtrim( divUnid_siglafiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.projetopratico.gx0020", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8punid_id,8,0))}, new String[] {"punid_id"})  ;
   }
   ...
   public void wb0N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblunid_idfilter_Internalname, "unid_id", "", "", lblLblunid_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0020.htm");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, divUnid_siglafiltercontainer_Internalname, 1, 0, "px", 0, "px", divUnid_siglafiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblunid_siglafilter_Internalname, "unid_sigla", "", "", lblLblunid_siglafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0020.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.projetopratico.GxWebStd.gx_label_element( httpContext, edtavCunid_sigla_Internalname, "unid_sigla", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.projetopratico.GxWebStd.gx_single_line_edit( httpContext, edtavCunid_sigla_Internalname, AV7cunid_sigla, GXutil.rtrim( localUtil.format( AV7cunid_sigla, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCunid_sigla_Jsonclick, 0, "Attribute", "", "", "", "", edtavCunid_sigla_Visible, edtavCunid_sigla_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "start", true, "", "HLP_Gx0020.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130n1_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0020.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
   ...
   public void rf0N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A9unid_sigla = H000N2_A9unid_sigla[0] ;
            A7unid_id = H000N2_A7unid_id[0] ;
            /* Execute user event: Load */
            e150N2 ();
   ...
   public void e140N2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "unidade", "", "", "", "", "", "", "", "") );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254918329", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0020.js", "?20254918329", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A7unid_id, (byte)(8), (byte)(0), ".", "")))+"'"+"]);" ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtunid_sigla_Internalname,A9unid_sigla,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtunid_sigla_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn OptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol34( )
   {
      if ( Grid1Container.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "unid_sigla") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A9unid_sigla));
         Grid1Container.AddColumnProperties(Grid1Column);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLUNID_IDFILTER.CLICK","{handler:'e110N1',iparms:[{av:'divUnid_idfiltercontainer_Class',ctrl:'UNID_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLUNID_SIGLAFILTER.CLICK","{handler:'e120N1',iparms:[{av:'divUnid_siglafiltercontainer_Class',ctrl:'UNID_SIGLAFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160N2',iparms:[{av:'A7unid_id',fld:'UNID_ID',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      A9unid_sigla = "" ;
      lV7cunid_sigla = "" ;
      H000N2_A9unid_sigla = new String[] {""} ;
      H000N2_A7unid_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projetopratico.gx0020__default(),
         new Object[] {
             new Object[] {
            H000N2_A9unid_sigla, H000N2_A7unid_id
            }
            , new Object[] {
   ...
   private String[] H000N2_A9unid_sigla ;
   private int[] H000N2_A7unid_id ;
...
final  class gx0020__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
            case 1 :
                  return conditional_H000N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() );
      }
