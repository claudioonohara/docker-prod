...
public final  class pessoa_endereco_impl extends GXDataArea
{
   ...
   public void drawControls( )
   {
      ...
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      /* Text block */
      com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblTitle_Internalname, "pessoa_endereco", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, (short)(0), "HLP_pessoa_endereco.htm");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_select_Internalname, "", "Select", bttBtn_select_Jsonclick, 5, "Select", "", StyleString, ClassString, bttBtn_select_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_enter_Internalname, "", "Confirm", bttBtn_enter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      /* Div Control */
      com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      ClassString = "Button button-tertiary" ;
      StyleString = "" ;
      com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_delete_Internalname, "", "Delete", bttBtn_delete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_pessoa_endereco.htm");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
      com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
   ...
   {
      /* Using cursor T00063 */
      pr_default.execute(1, new Object[] {Integer.valueOf(A1pes_id), Integer.valueOf(A17end_id)});
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm066( 1) ;
         RcdFound6 = (short)(1) ;
         A1pes_id = T00063_A1pes_id[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1pes_id), 8, 0));
         A17end_id = T00063_A17end_id[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A17end_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A17end_id), 8, 0));
         Z1pes_id = A1pes_id ;
         Z17end_id = A17end_id ;
         sMode6 = Gx_mode ;
   ...
   public void move_next( )
   {
      ...
      pr_default.execute(8, new Object[] {Integer.valueOf(A1pes_id), Integer.valueOf(A1pes_id), Integer.valueOf(A17end_id)});
      if ( (pr_default.getStatus(8) != 101) )
      {
         while ( (pr_default.getStatus(8) != 101) && ( ( T000610_A1pes_id[0] < A1pes_id ) || ( T000610_A1pes_id[0] == A1pes_id ) && ( T000610_A17end_id[0] < A17end_id ) ) )
         {
            pr_default.readNext(8);
         }
         if ( (pr_default.getStatus(8) != 101) && ( ( T000610_A1pes_id[0] > A1pes_id ) || ( T000610_A1pes_id[0] == A1pes_id ) && ( T000610_A17end_id[0] > A17end_id ) ) )
         {
            A1pes_id = T000610_A1pes_id[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1pes_id), 8, 0));
            A17end_id = T000610_A17end_id[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A17end_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A17end_id), 8, 0));
            RcdFound6 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      pr_default.execute(9, new Object[] {Integer.valueOf(A1pes_id), Integer.valueOf(A1pes_id), Integer.valueOf(A17end_id)});
      if ( (pr_default.getStatus(9) != 101) )
      {
         while ( (pr_default.getStatus(9) != 101) && ( ( T000611_A1pes_id[0] > A1pes_id ) || ( T000611_A1pes_id[0] == A1pes_id ) && ( T000611_A17end_id[0] > A17end_id ) ) )
         {
            pr_default.readNext(9);
         }
         if ( (pr_default.getStatus(9) != 101) && ( ( T000611_A1pes_id[0] < A1pes_id ) || ( T000611_A1pes_id[0] == A1pes_id ) && ( T000611_A17end_id[0] < A17end_id ) ) )
         {
            A1pes_id = T000611_A1pes_id[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1pes_id), 8, 0));
            A17end_id = T000611_A17end_id[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A17end_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A17end_id), 8, 0));
            RcdFound6 = (short)(1) ;
         }
      }
   ...
   public void checkOptimisticConcurrency066( )
   {
      ...
      {
         /* Using cursor T00062 */
         pr_default.execute(0, new Object[] {Integer.valueOf(A1pes_id), Integer.valueOf(A17end_id)});
   ...
   public void scanStart066( )
   {
      ...
      {
         RcdFound6 = (short)(1) ;
         A1pes_id = T000614_A1pes_id[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1pes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1pes_id), 8, 0));
         A17end_id = T000614_A17end_id[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A17end_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(A17end_id), 8, 0));
      }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projetopratico.pessoa_endereco", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.projetopratico.pessoa_endereco", new String[] {}, new String[] {})  ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025491825335", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("pessoa_endereco.js", "?2025491825335", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("VALID_END_ID","{handler:'valid_End_id',iparms:[{av:'A1pes_id',fld:'PES_ID',pic:'ZZZZZZZ9'},{av:'A17end_id',fld:'END_ID',pic:'ZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
      setEventMetadata("VALID_END_ID",",oparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z1pes_id'},{av:'Z17end_id'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      endTrnMsgTxt = "" ;
      endTrnMsgCod = "" ;
      T00066_A1pes_id = new int[1] ;
      T00066_A17end_id = new int[1] ;
      T00064_A1pes_id = new int[1] ;
      T00065_A17end_id = new int[1] ;
      T00067_A1pes_id = new int[1] ;
      T00068_A17end_id = new int[1] ;
      T00069_A1pes_id = new int[1] ;
      T00069_A17end_id = new int[1] ;
      T00063_A1pes_id = new int[1] ;
      T00063_A17end_id = new int[1] ;
      sMode6 = "" ;
      T000610_A1pes_id = new int[1] ;
      T000610_A17end_id = new int[1] ;
      T000611_A1pes_id = new int[1] ;
      T000611_A17end_id = new int[1] ;
      T00062_A1pes_id = new int[1] ;
      T00062_A17end_id = new int[1] ;
      T000614_A1pes_id = new int[1] ;
      T000614_A17end_id = new int[1] ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      T000615_A1pes_id = new int[1] ;
      T000616_A17end_id = new int[1] ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projetopratico.pessoa_endereco__default(),
         new Object[] {
             new Object[] {
            T00062_A1pes_id, T00062_A17end_id
            }
            , new Object[] {
            T00063_A1pes_id, T00063_A17end_id
            }
            , new Object[] {
            T00064_A1pes_id
            }
            ...
            , new Object[] {
            T00066_A1pes_id, T00066_A17end_id
            }
            , new Object[] {
            T00067_A1pes_id
            }
            ...
            , new Object[] {
            T00069_A1pes_id, T00069_A17end_id
            }
            , new Object[] {
            T000610_A1pes_id, T000610_A17end_id
            }
            , new Object[] {
            T000611_A1pes_id, T000611_A17end_id
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T000614_A1pes_id, T000614_A17end_id
            }
            , new Object[] {
            T000615_A1pes_id
            }
   ...
   private int[] T00066_A1pes_id ;
   private int[] T00066_A17end_id ;
   private int[] T00064_A1pes_id ;
   private int[] T00065_A17end_id ;
   private int[] T00067_A1pes_id ;
   private int[] T00068_A17end_id ;
   private int[] T00069_A1pes_id ;
   private int[] T00069_A17end_id ;
   private int[] T00063_A1pes_id ;
   private int[] T00063_A17end_id ;
   private int[] T000610_A1pes_id ;
   private int[] T000610_A17end_id ;
   private int[] T000611_A1pes_id ;
   private int[] T000611_A17end_id ;
   private int[] T00062_A1pes_id ;
   private int[] T00062_A17end_id ;
   private int[] T000614_A1pes_id ;
   private int[] T000614_A17end_id ;
   private int[] T000615_A1pes_id ;
   private int[] T000616_A17end_id ;
}
...
final  class pessoa_endereco__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("T00062", "SELECT pes_id, end_id FROM pessoa_endereco WHERE pes_id = ? AND end_id = ?  FOR UPDATE OF pessoa_endereco NOWAIT",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00063", "SELECT pes_id, end_id FROM pessoa_endereco WHERE pes_id = ? AND end_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00064", "SELECT pes_id FROM pessoa WHERE pes_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00065", "SELECT end_id FROM endereco WHERE end_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00066", "SELECT TM1.pes_id, TM1.end_id FROM pessoa_endereco TM1 WHERE TM1.pes_id = ? and TM1.end_id = ? ORDER BY TM1.pes_id, TM1.end_id ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00067", "SELECT pes_id FROM pessoa WHERE pes_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00068", "SELECT end_id FROM endereco WHERE end_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00069", "SELECT pes_id, end_id FROM pessoa_endereco WHERE pes_id = ? AND end_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000610", "SELECT pes_id, end_id FROM pessoa_endereco WHERE ( pes_id > ? or pes_id = ? and end_id > ?) ORDER BY pes_id, end_id  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("T000611", "SELECT pes_id, end_id FROM pessoa_endereco WHERE ( pes_id < ? or pes_id = ? and end_id < ?) ORDER BY pes_id DESC, end_id DESC  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new UpdateCursor("T000612", "SAVEPOINT gxupdate;INSERT INTO pessoa_endereco(pes_id, end_id) VALUES(?, ?);RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T000613", "SAVEPOINT gxupdate;DELETE FROM pessoa_endereco  WHERE pes_id = ? AND end_id = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new ForEachCursor("T000614", "SELECT pes_id, end_id FROM pessoa_endereco ORDER BY pes_id, end_id ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000615", "SELECT pes_id FROM pessoa WHERE pes_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000616", "SELECT end_id FROM endereco WHERE end_id = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
