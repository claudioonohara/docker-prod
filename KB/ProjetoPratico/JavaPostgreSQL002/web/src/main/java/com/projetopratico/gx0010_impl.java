...
public final  class gx0010_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projetopratico.gx0010", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV9ppes_id,8,0))}, new String[] {"ppes_id"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "GXH_vCPES_DATA_NASCIMENTO", localUtil.format(AV7cpes_data_nascimento, "99/99/99"));
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "GXH_vCPES_SEXO", AV8cpes_sexo);
      /* Send saved values. */
      ...
      com.projetopratico.GxWebStd.gx_hidden_field( httpContext, "PES_SEXOFILTERCONTAINER_Class", GXutil.rtrim( divPes_sexofiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.projetopratico.gx0010", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV9ppes_id,8,0))}, new String[] {"ppes_id"})  ;
   }
   ...
   public void wb0O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblpes_idfilter_Internalname, "pes_id", "", "", lblLblpes_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0010.htm");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, divPes_data_nascimentofiltercontainer_Internalname, 1, 0, "px", 0, "px", "AdvancedContainerItem AdvancedContainerItemExpanded", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblpes_data_nascimentofilter_Internalname, "pes_data_nascimento", "", "", lblLblpes_data_nascimentofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WWAdvancedLabel WWDateFilterLabel", 0, "", 1, 1, 0, (short)(1), "HLP_Gx0010.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.projetopratico.GxWebStd.gx_label_element( httpContext, edtavCpes_data_nascimento_Internalname, "pes_data_nascimento", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         ...
         com.projetopratico.GxWebStd.gx_single_line_edit( httpContext, edtavCpes_data_nascimento_Internalname, localUtil.format(AV7cpes_data_nascimento, "99/99/99"), localUtil.format( AV7cpes_data_nascimento, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpes_data_nascimento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCpes_data_nascimento_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "end", false, "", "HLP_Gx0010.htm");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, divPes_sexofiltercontainer_Internalname, 1, 0, "px", 0, "px", divPes_sexofiltercontainer_Class, "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         com.projetopratico.GxWebStd.gx_label_ctrl( httpContext, lblLblpes_sexofilter_Internalname, "pes_sexo", "", "", lblLblpes_sexofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0010.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.projetopratico.GxWebStd.gx_label_element( httpContext, edtavCpes_sexo_Internalname, "pes_sexo", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'',false,'" + sGXsfl_44_idx + "',0)\"" ;
         com.projetopratico.GxWebStd.gx_single_line_edit( httpContext, edtavCpes_sexo_Internalname, AV8cpes_sexo, GXutil.rtrim( localUtil.format( AV8cpes_sexo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpes_sexo_Jsonclick, 0, "Attribute", "", "", "", "", edtavCpes_sexo_Visible, edtavCpes_sexo_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "start", true, "", "HLP_Gx0010.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 44, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130o1_client"+"'", TempTags, "", 2, "HLP_Gx0010.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.projetopratico.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      if ( wbEnd == 44 )
      {
         ...
         StyleString = "" ;
         com.projetopratico.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 44, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0010.htm");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.projetopratico.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A3pes_data_nascimento = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtpes_data_nascimento_Internalname), 0)) ;
   ...
   public void rf0O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV8cpes_sexo ,
                                              A3pes_data_nascimento ,
                                              A4pes_sexo ,
                                              Integer.valueOf(AV6cpes_id) } ,
                                              new int[]{
                                              TypeConstants.DATE, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.INT
                                              }
         });
         ...
         {
            A4pes_sexo = H000O2_A4pes_sexo[0] ;
            A3pes_data_nascimento = H000O2_A3pes_data_nascimento[0] ;
            A1pes_id = H000O2_A1pes_id[0] ;
            /* Execute user event: Load */
            e150O2 ();
   ...
   public void strup0O0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( localUtil.vcdate( httpContext.cgiGet( edtavCpes_data_nascimento_Internalname), (byte)(2)) == 0 )
         {
         ...
         {
            AV7cpes_data_nascimento = localUtil.ctod( httpContext.cgiGet( edtavCpes_data_nascimento_Internalname), 2) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7cpes_data_nascimento", localUtil.format(AV7cpes_data_nascimento, "99/99/99"));
         }
         ...
         if ( !( GXutil.dateCompare(GXutil.resetTime(localUtil.ctod( httpContext.cgiGet( "GXH_vCPES_DATA_NASCIMENTO"), 2)), GXutil.resetTime(AV7cpes_data_nascimento)) ) )
         {
            GRID1_nFirstRecordOnPage = 0 ;
         }
         if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCPES_SEXO"), AV8cpes_sexo) != 0 )
   ...
   public void e140O2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "pessoa", "", "", "", "", "", "", "", "") );
   ...
   public void e160O2( )
   {
      ...
      AV9ppes_id = A1pes_id ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9ppes_id", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9ppes_id), 8, 0));
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV9ppes_id)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9ppes_id"});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025491825957", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0010.js", "?2025491825957", false, true);
   ...
   public void sendrow_442( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A1pes_id, (byte)(8), (byte)(0), ".", "")))+"'"+"]);" ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtpes_sexo_Internalname,A4pes_sexo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtpes_sexo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn OptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(9),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(44),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol44( )
   {
      if ( Grid1Container.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "pes_data_nascimento") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "pes_sexo") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( localUtil.format(A3pes_data_nascimento, "99/99/99")));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A4pes_sexo));
         Grid1Container.AddColumnProperties(Grid1Column);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e130O1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
      setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLPES_IDFILTER.CLICK","{handler:'e110O1',iparms:[{av:'divPes_idfiltercontainer_Class',ctrl:'PES_IDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLPES_SEXOFILTER.CLICK","{handler:'e120O1',iparms:[{av:'divPes_sexofiltercontainer_Class',ctrl:'PES_SEXOFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160O2',iparms:[{av:'A1pes_id',fld:'PES_ID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9ppes_id',fld:'vPPES_ID',pic:'ZZZZZZZ9'}]}");
   ...
   public void initialize( )
   {
      ...
      A4pes_sexo = "" ;
      lV8cpes_sexo = "" ;
      H000O2_A4pes_sexo = new String[] {""} ;
      H000O2_A3pes_data_nascimento = new java.util.Date[] {GXutil.nullDate()} ;
      H000O2_A1pes_id = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projetopratico.gx0010__default(),
         new Object[] {
             new Object[] {
            H000O2_A4pes_sexo, H000O2_A3pes_data_nascimento, H000O2_A1pes_id
            }
            , new Object[] {
   ...
   private String[] H000O2_A4pes_sexo ;
   private java.util.Date[] H000O2_A3pes_data_nascimento ;
   private int[] H000O2_A1pes_id ;
...
final  class gx0010__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000O2( ModelContext context ,
                                          ...
                                          java.util.Date AV7cpes_data_nascimento ,
                                          String AV8cpes_sexo ,
                                          java.util.Date A3pes_data_nascimento ,
                                          String A4pes_sexo ,
                                          int AV6cpes_id )
   {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000O2(context, remoteHandle, httpContext, (java.util.Date)dynConstraints[0] , (String)dynConstraints[1] , (java.util.Date)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() );
            case 1 :
                  return conditional_H000O3(context, remoteHandle, httpContext, (java.util.Date)dynConstraints[0] , (String)dynConstraints[1] , (java.util.Date)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() );
      }
