...
@jakarta.xml.bind.annotation.XmlType(name = "apiservidorefetivo_servidorefetivo__get_RESTInterfaceOUT", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class apiservidorefetivo_servidorefetivo__get_RESTInterfaceOUT
{
